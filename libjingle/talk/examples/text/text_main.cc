...
int main(int argc, char **argv) {
  ...
  talk_base::PhysicalSocketServer ss; //create the server socket

  TextClient *client = new TextClient(pump.client()); //create a client
  
  talk_base::Thread main_thread(&ss); //passing the created socket to the main thread
  talk_base::ThreadManager::SetCurrent(&main_thread); //passing the main thread to the threadManager
